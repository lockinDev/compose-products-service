...
import se.lockin.api.composite.product.ProductAggregate;
import se.lockin.api.composite.product.RecommendationSummary;
import se.lockin.api.composite.product.ReviewSummary;
...
import se.lockin.api.event.Event;
import se.lockin.microservices.composite.product.services.ProductCompositeIntegration;
...
import static se.lockin.api.event.Event.Type.CREATE;
import static se.lockin.api.event.Event.Type.DELETE;
import static se.lockin.microservices.composite.product.IsSameEvent.sameEventExceptCreatedAt;
